            ...
            <div className='w-1/2   border-red mx-auto pt-32'>
                ...
                <form className=''>
                    ...
                    <div class="flex items-start mb-6">
                        ...
                        <Link to={'/terms'} style={{ textDecoration: 'underline' }}>    <label for="terms and condition" class="ml-2 text-sm font-medium text-gray-900">terms and condition</label></Link>
                    </div>
